...
const Vote = (props) => {
	...
	return (
		<div>
		  <p>{showVotes}</p>			
          <button id="upVoteButton" onClick={handleUpVoteClick}>UpVote ↑ {upVotes}</button><br/><br/>
          <button id="downVoteButton" onClick={handleDownVoteClick}>DownVote ↓ {downVotes}</button>
		</div>
	);
};
